# ===============================================
# Deploy Planner.Worker (self-contained, tag :latest)
# Compatible with containerapp v1.2.0b5
# ===============================================

param (
    [string]$RESOURCE_GROUP = "PlannerRG",
    [string]$APP_FOLDER     = "Planner.Optimization.Worker",
    [string]$ACR_NAME       = "plannerregistry"
)

Write-Host "==============================================="
Write-Host " Deploying $($APP_FOLDER) (self-contained build)"
Write-Host "==============================================="

# Normalize image repo name
$IMAGE_REPO = $APP_FOLDER.ToLower() -replace '\.', '-'
$APP_NAME   = "planner-worker"
