...
namespace Planner.Infrastructure.Migrations
{
    ...
    [Migration("20260402100243_CheckModelDrift")]
    partial class AddVehicleDepotForeignKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Planner.Domain.Vehicle", b =>
                {
                    ...
                    b.HasIndex("DepotEndId");

                    b.HasIndex("DepotStartId");
            ...
            modelBuilder.Entity("Planner.Domain.Vehicle", b =>
                {
                    b.HasOne("Planner.Domain.Depot", "EndDepot")
                        .WithMany()
                        .HasForeignKey("DepotEndId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Planner.Domain.Depot", "StartDepot")
                        .WithMany()
                        .HasForeignKey("DepotStartId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
